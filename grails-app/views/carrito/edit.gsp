...
<html>
	...
	<body>
		<a href="#edit-carrito" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-carrito" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${carritoInstance?.version}" />
				<fieldset class="form">
