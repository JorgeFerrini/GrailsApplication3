...
<html>
	...
	<body>
		<a href="#create-productos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-productos" class="content scaffold-create" role="main">
