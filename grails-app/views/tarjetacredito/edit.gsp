...
<html>
	...
	<body>
		<a href="#edit-tarjetacredito" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
				<li><g:link class="list" action="list">Tarjetas</g:link></li>
				<li><g:link class="create" action="create">Agregar Tarjetas</g:link></li>
		...
		<div id="edit-tarjetacredito" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${tarjetacreditoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${tarjetacreditoInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${tarjetacreditoInstance?.version}" />
				<fieldset class="form">
